  ...
  struct SVGrenderInfo;
    ...
    **/
    struct AST_Node {
      ...
      virtual AST_Node* duplicate() const;
    ...
    struct AST_Node_Unary: AST_Node {
      ...
      AST_Node* duplicate() const override;
    ...
    struct AST_Node_new: AST_Node {
      ...
      full_type coerce(const ErrorContext &errc) const override; ///< Returns the contained type, with another pointer on the ref stack.
      string toString() const override;
      void toSVG(int x, int y, SVGrenderInfo* svg) override;
    ...
    struct AST_Node_Cast: AST_Node_Unary {
      ...
      string toString() const override;
      void toSVG(int x, int y, SVGrenderInfo* svg) override;
      int height() override; ///< Returns the height which will be used to render this node and all its children.
    ...
    struct AST_Node_Scope: AST_Node_Binary {
      ...
      AST_Node_Scope(AST_Node* left, AST_Node* right, string op);
    };
    ...
    struct AST_Node_TempInst: AST_Node {
      ...
      virtual void toSVG(int x, int y, SVGrenderInfo* svg) override;
